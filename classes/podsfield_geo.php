...
class PodsField_Geo extends PodsField {
	 ...
	 * @since 2.0
	 */
	public static $label = 'GeoComplete';
	...
	public function input ( $name, $value = null, $options = null, $pod = null, $id = null ) {
		...
		pods_view(PODS_GEO_FIELD_DIR 
			. 'ui/fields/geocomplete.php', compact( array_keys( get_defined_vars() ) ) );
	}
